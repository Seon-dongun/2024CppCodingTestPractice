...
<h2> 풀이 </h2>
<p>핵심은 각각의 weight에 대한 2:3, 3:4, 2:4(=1:2)의 관계인 숫자가 있는지 사전에 카운팅된 배열을 확인해서 answer에 더해주면 되는 것. 중복 없는 weight의 경우는 상관없지만 중복이 있는 배열의 경우, 별도로 동일한 weight끼리의 조합도 생각해주어야 하기 때문에, 별도로 더 구해준다.</p>
