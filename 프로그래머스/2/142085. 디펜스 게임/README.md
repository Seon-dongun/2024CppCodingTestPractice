...
<hr>
<h2>풀이</h2>
<p>핵심은 우선순위 큐를 사용하는 것이다. 앞에서부터 하나씩 적들을 막아내면서, 만일 막아낼 수 있는 최대치인 n을 넘는 경우는 앞서 막아내는 동안의 가장 많은 적이 온 경우를 무적권으로 막아주어야 한다. 이를 위해서 적군의 수를 순회하는 과정에서 우선순위 큐에 집어 넣는 작업을 해주다가, 문제의 순간에 여태까지 만난 적군의 수 중에서 가장 큰 값을 즉시 얻어내어 무적권으로 처리해줄 수 있다.</p>
